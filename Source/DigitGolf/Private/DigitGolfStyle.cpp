...
TSharedPtr< FSlateStyleSet > FDigitGolfStyle::StyleInstance = NULL;

void FDigitGolfStyle::Initialize()
{
...
FName FDigitGolfStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("DigitGolfStyle"));
	return StyleSetName;
}
...
void FDigitGolfStyle::ReloadTextures()
{
	FSlateApplication::Get().GetRenderer()->ReloadTextureResources();
}

const ISlateStyle& FDigitGolfStyle::Get()
{
